      ...
      <div className="flex flex-col h-screen justify-between">
        <div className="h-full flex flex-col divide-y divide-neutral-800">
            <div className="flex items-center justify-center p-4">
                <img alt="" width="128" height="128" src={usePath("icons/user.svg")} className="p-4 aspect-square rounded-full" />
                <div className="pr-4">
            ...
            <div className="flex justify-between items-center p-2">
              <div className="flex gap-2">
                ...
                <RoundButton link="https://www.facebook.com/daniel.sarin.58/">
                  <img alt="" width="28" height="28" src={usePath("icons/facebook.svg")} className="aspect-square opacity-75 rounded-md" />
                </RoundButton>
              </div>
              <div className="flex justify-end">
                <RoundButton link={usePath("cv")} color="#212121af">
